...
describe('version', function () {
  describe('An ostrich store for an example ostrich path', function () {
    ...
    describe('being searched', function () {
      ...
      describe('with pattern null null null', function () {
        ...
        before(function (done) {
          document.searchTriplesVersion(null, null, null)
            .then(({ triples: t, totalCount: c, hasExactCount: e }) => {
              triples = t;
              totalCount = c;
              hasExactCount = e;
              done();
      ...
      describe.skip('with pattern null null null, offset 20 and limit 5', function () { // TODO: fix me
        var triples, totalCount, hasExactCount;
        before(function (done) {
      ...
      describe.skip('with pattern c null null, offset 10 and limit 1', function () { // TODO: fix me
        var triples, totalCount, hasExactCount;
        before(function (done) {
