...
OstrichStorePrototype.countTriplesVersionMaterialized = function (subject, predicate, object, version) {
  ...
  return new Promise((resolve, reject) => {
    this.searchTriplesVersionMaterialized(null, null, 'f', { version: 0 })
      .then(([t, tc, e]) => {
        resolve([tc, e]);
      }).catch((e) => {
        reject(e);
...
OstrichStorePrototype.close = function (remove) {
...
OstrichStorePrototype._close = function (remove, callback, self) {
...
module.exports = {
  ...
  fromPath: function (path, readOnly) {
    return new Promise((resolve, reject) => {
